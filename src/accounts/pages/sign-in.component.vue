...
<template>
  <div class="flex justify-center items-center">
    <form class="flex flex-col container max-w-md items-center mt-8 space-y-4" @submit.prevent="handleLogin">
      <div class="mb-6">
      ...
      <div class="w-full">
        ...
        <span v-if="v$.email.$error && submitted">
          <span v-for="(error, index) of v$.email.$errors" id="signin_email-error" :key="index">
      ...
      <div class="w-full">
        ...
        <span v-if="v$.password.$error && submitted">
          <span v-for="(error, index) of v$.password.$errors" id="signin_password-error" :key="index">
            <small class="p-error">{{ error.$message }}</small>
          </span>
        </span>
      </div>
